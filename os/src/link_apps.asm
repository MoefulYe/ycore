...
app_3_end:
    ...
    .global app_4_end
app_4_start:
    .incbin "../user/target/riscv64gc-unknown-none-elf/release/04load_fault.bin"
app_4_end:
    ...
    .global app_5_end
app_5_start:
    .incbin "../user/target/riscv64gc-unknown-none-elf/release/05store_fault.bin"
app_5_end:
    ...
    .global app_6_end
app_6_start:
    .incbin "../user/target/riscv64gc-unknown-none-elf/release/sbrk_test.bin"
app_6_end:
